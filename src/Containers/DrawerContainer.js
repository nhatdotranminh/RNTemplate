      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.header}>
          <View style={styles.avatarWrapper}>
            <Image source={Images.android} style={styles.avatarImage} />
          </View>
        </View>

        <ScrollView contentContainerStyle={styles.body}>
          <Button
            onPress={() => navigate(ScreenKey.HOME_SCREEN)}
            labelWrapper={styles.labelButtonWrapper}
            label={I18n.t("home")}
            buttonStyle={[
              styles.buttonWrapper,
              this.changeforegroundRowFocusStyle(
                activeItemKey,
                ScreenKey.HOME_SCREEN
              )
            ]}
            labelText={[
              this.changeForegroundTextStyle(
                activeItemKey,
                ScreenKey.HOME_SCREEN
              )
            ]}
            ...
            iconType={"Entypo"}
            name={"home"}
            iconColor={this.changeForegroundIconStyle(
              activeItemKey,
              ScreenKey.HOME_SCREEN
            )}
          />
          ...
          <Button
            onPress={() => navigate(ScreenKey.A_STACK)}
            labelWrapper={styles.labelButtonWrapper}
            ...
            labelText={[
              this.changeForegroundTextStyle(activeItemKey, ScreenKey.A_STACK)
            ]}
            iconWrapper={styles.iconWrapper}
          ...
          <Button
            onPress={() => navigate(ScreenKey.B_SCREEN)}
            labelWrapper={styles.labelButtonWrapper}
            ...
            labelText={[
              this.changeForegroundTextStyle(activeItemKey, ScreenKey.B_SCREEN)
            ]}
            iconWrapper={styles.iconWrapper}
            iconType={"MaterialCommunityIcons"}
